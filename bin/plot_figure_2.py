...
max_smooth_1 = get_scale_factor(smooth_1, 90)
max_smooth_2 = get_scale_factor(smooth_2, 90)
max_smooth_3 = get_scale_factor(smooth_3, 101)
...
plt.semilogy(smooth_1[:,0], scale_factor*smooth_1[:,1], '#1f77b4', label='Single Intensity, $I_{max} = 1.9$x$10^{14}$ W cm$^{-2}$)')
